	...
	<table class="table-custom text-uppercase" style="width:100%; padding-top: 0px; padding-bottom: 2px; font-size:7pt">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Fecha de elaboración: {{ $fechaElaboracion }} </td>
            </tr>
            <tr>
                <td class="table-subtitle">Periodo</td>
                <td>Semana {{ $semana }} del {{ $periodo->fecha_inicio_formatted }} al {{ $periodo->fecha_fin_formatted }}</td>
            </tr>
        </tbody>
    </table>
